from selectabletext_lib.helperclass import detection
import os
class SelectableText_lib:
    ...
    def addText(self, text: str, functionname = None, functionvariables = None):
        if (functionname==None):
            functionname=self.voidfunct
        self.TextCount += 1
        self._TextDictonary[self.TextCount] = (text, functionname, functionvariables)
